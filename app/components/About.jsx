      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-12 lg:gap-28 px-4 md:px-6">
        ...
        <div className="w-full md:w-1/2 space-y-4 px-2 md:px-0">
          ...
          <p className="text-white text-lg">
            ...
            professional stylists is dedicated to providing you with the best
            hair care experience. We believe that a great hairstyle can boost
            your confidence and make you feel amazing.
          </p>
          <p className="text-white text-lg">
            Founded by Patrick Potter, our salon has been a cornerstone of the
            community for over a decade. We offer a wide range of services, from
            haircuts and coloring to special occasion styling. Our mission is to
            make every client feel special and leave our salon looking and
            feeling their best.
          </p>
          <a
            href="#services"
